...
ANIMATION::ANIMATION(const char*dir, const char*name, int SplitNumALL, int SplitNumX, int SplitNumY, int SplitWidth, int SplitHeight, double ChageSpeed, bool IsLoop)
{
	this->FilePath = "";
	this->FileName = "";
	...
	this->ChangeMaxCnt = (int)(ChageSpeed * fps->Getvalue());
	this->ChangeCnt = 0;
	...
	LoadDivGraph(LoadfilePath.c_str(), SplitNumALL, SplitNumX, SplitNumY, SplitWidth, SplitHeight, &this->Handle[0]);
	...
	this->NextChangeSpeed = ChageSpeed;
